...
<script language="VB" runat="server">
    ...
    ' 1) Copy and re-name this file as LISTim_Employee.txt, where Employee is the name of your database table
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p  align="center"><b><font size="5" color="#000000">View Employees</font></b></p>
...
<asp:datagrid id="_gd1" runat=server AutoGenerateColumns="True" 
  ...
  Align="center">
   ...
   <br />
<Center><a align="center" class="mis311-hoverbutton" href="customer-edit.aspx">BACK</a></center>
</asp:Content>
